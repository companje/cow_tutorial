...
CoW is intended for anyone who has Python installed, can use the command line and can edit a text file. Examples of CoW conversions can be found [here](https://github.com/CLARIAH/wp4-cow-conversions). CoW is amongst others being used to transpose the Dutch civil registration to Linked Data (https://repository.ubn.ru.nl/bitstream/handle/2066/225728/225728pub.pdf?sequence=1).
